...
workExperienceRoute.get("/work-experience/:id", verifyAll, getAllWorkExperience);

// POST: Create a new city
workExperienceRoute.post("/work-experience/:id",verifyAll,createWorkExperience);

// PUT: Update an existing work
workExperienceRoute.put("/work-experience/:id",verifyAll,updateWorkExperience);

// DELETE: Delete a work
workExperienceRoute.delete("/work-experience/:id", verifyAll,deleteWorkExperience);
